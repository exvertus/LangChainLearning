...
class CustomSerpAPI(SerpAPIWrapper):
    def __init__(self):
        super().__init__()

    @staticmethod
    def _process_response(res: dict, return_first_organic_result_with="link") -> str:
        ...
        for organic_result in res.get("organic_results", []):
            if return_first_organic_result_with in organic_result.keys():
                return organic_result[return_first_organic_result_with]
